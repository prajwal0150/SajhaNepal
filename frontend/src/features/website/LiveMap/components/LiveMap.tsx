...
import type { NeedType, Report, Urgency } from '@shared/types';
import { NEPAL_CENTER } from '@shared/utils/format';
import { MAP_TILE_URL } from '../utils/mapTiles';
...
/**
 * Live relief map rendered on Google Road tiles via Leaflet.
 */
export function LiveMap({ reports, center, radiusKm, showRadius, onRetryGeolocate }: {
  ...
  return (
    <div className="relative h-full w-full" role="application" aria-label="Live relief map">
      <MapContainer center={initial} zoom={zoom} className="h-full w-full" scrollWheelZoom>
        <TileLayer url={MAP_TILE_URL} attribution='&copy; <a href="https://www.google.com/intl/en_us/help/terms_maps.html">Google</a>' />
